...
filters_config = {
    'bear':
        [{'path': "./filters/bear.png",
          'anno_path': "./filters/bear2.csv",
...
def getLandmarks(img):
    ...
    temp = [127, 93, 58, 136, 150, 149, 176, 148, 152, 377, 400, 378, 379, 365, 288, 323, 356, 70, 63, 105, 66, 55,
                 285, 296, 334, 293, 300, 168, 6, 195, 4, 64, 60, 94, 290, 439, 33, 160, 158, 173, 153, 144, 398, 385,
                 387, 466, 373, 380, 61, 40, 39, 0, 269, 270, 291, 321, 405, 17, 181, 91, 78, 81, 13, 311, 306, 402, 14,
                 178, 162, 54, 67, 10, 297, 284, 389]
    selected_keypoint_indices=[temp[36],temp[37],temp[38],temp[39],temp[40],temp[41],temp[42],temp[43],temp[44],temp[45],temp[46],temp[47],temp[48],temp[49],temp[50],temp[51],temp[52],temp[53],temp[54],temp[55],temp[56],temp[57],temp[58],temp[59],temp[60],temp[61],temp[62],temp[63],temp[64],temp[65],temp[66],temp[67]]
